...
abstract class Base extends \Magento\Backend\App\Action
{
    ...
    public function validate()
    {
        ...
        $orderPrefix = $this->getRequest()->getParam(\Ced\Amazon\Model\Account::COLUMN_ORDER_PREFIX, '');
...
//            unset(self::$fields[\Ced\Amazon\Model\Account::COLUMN_SECRET_KEY]);
        ...
        if (empty($this->invalid)) {
            $this->data->addData([
                ...
                \Ced\Amazon\Model\Account::COLUMN_SHIPPING_METHOD =>json_encode($shipping),
                ...
                \Ced\Amazon\Model\Account::COLUMN_ORDER_PREFIX => $orderPrefix,
            ]);
