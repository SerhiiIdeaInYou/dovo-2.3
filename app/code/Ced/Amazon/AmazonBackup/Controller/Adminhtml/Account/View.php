...
class View extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Ced\Amazon\Api\ProfileRepositoryInterface $profileRepository
    ) {
    ...
    public function execute()
    {
        ...
        $profileId = $this->getRequest()->getParam('profile_id', 0);
        ...
        try {
            ...
            if (!empty($marketplaceIds)) {
             ...
             $value = $marketplaceIds[0];
            if ($profileId) {
                $profile = $this->profile->getById($profileId);
                $value = $profile->getData('marketplace');
            }
