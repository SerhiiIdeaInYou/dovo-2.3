...
interface ConfigServiceInterface
{
    ...
    const CONFIG_PATH_AMAZON_MINIMUM_PRICE_TYPE_ATTRIBUTE = "amazon/product/price/amazon_minimum_price";
    ...
    const CONFIG_PATH_TIER_PRICE_CUSTOMER_GROUP = "amazon/product/price/customer_group";
    ...
    const CONFIG_PATH_INVENTORY_FULFILLMENT_OVERRIDE = "amazon/product/inventory/override_fulfilment_latency";
    const CONFIG_PATH_INVENTORY_FULFILLMENT_PRODUCT_LEVEL = "amazon/product/inventory/fulfilment_latency_product_attribute";
    ...
    const CONFIG_PATH_INVENTORY_SEND_SALABLE_QUANTITY = "amazon/product/inventory/send_salable_quantity";
