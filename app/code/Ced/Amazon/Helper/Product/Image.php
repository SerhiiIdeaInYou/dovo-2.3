...
//                ->addAttributeToSelect(['sku', 'entity_id', 'type_id', 'thumbnail', 'image', 'small_image'])
                ->addAttributeToSelect(['sku', 'entity_id', 'type_id', 'thumbnail', 'image', 'small_image', $skuAttribute])
...
//                            $i->setData($product->getSku(), $imageTypes[$counter++], $url);
                            $i->setData($product->getData($skuAttribute), $imageTypes[$counter++], $url);
                            $envelope->addImage($i);
                        }
                    }
...
//                                $i->setData($child->getSku(), $imageTypes[$counter++], $url);
                                $i->setData($child->getData($skuAttribute), $imageTypes[$counter++], $url);
                                $envelope->addImage($i);
                            }
                        }
...
//                            $i->setData($child->getSku(), 'Main', $main);
                            $i->setData($child->getData($skuAttribute), 'Main', $main);
                            $envelope->addImage($i);
                        }
                    }
...
//                            $i->setData($product->getSku(), 'Main', $main);
                            $i->setData($product->getData($skuAttribute), 'Main', $main);
                            $envelope->addImage($i);
                        }
                    }
                }
