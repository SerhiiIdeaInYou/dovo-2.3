...
namespace Marketingseals\BestCheckout\Plugin\Block;
...
class LayoutProcessor
{
    ...
    )
    {
        ...
        if ($this->getQuote()->isVirtual()) {
            ...
            $jsLayoutResult['components']['checkout']['children']['steps']['children']['virtual-billing-step']['children']['billing-address'] = $this->getCustomVirtualBillingAddressComponent($elements);

            $jsLayoutResult['components']['checkout']['children']['steps']['children']['virtual-billing-step']['children']['billing-address']['children']['form-fields']['children']['street']['children'][0]['placeholder'] = __('Street Address');
            $jsLayoutResult['components']['checkout']['children']['steps']['children']['virtual-billing-step']['children']['billing-address']['children']['form-fields']['children']['street']['children'][1]['placeholder'] = __('Street line 2');
    ...
    {
        return [
            'component' => 'Marketingseals_BestCheckout/js/view/billing-address',
     ...
     * @return array
     */
    public function getCustomVirtualBillingAddressComponent($elements)
    {
        return [
            'component' => 'Marketingseals_BestCheckout/js/view/virtual/billing-address',
            'displayArea' => 'virtual-billing-address',
            'provider' => 'checkoutProvider',
            'deps' => ['checkoutProvider'],
            'dataScopePrefix' => 'billingAddress',
            'children' => [
