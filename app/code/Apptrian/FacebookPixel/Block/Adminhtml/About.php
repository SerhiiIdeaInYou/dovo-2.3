...
<p>
<strong>Apptrian Facebook Pixel Extension v$version</strong><br /><br />
Adds Facebook Pixel with standard events and Dynamic Ads code on appropriate 
pages. Supports Advanced Matching (if the customer is logged in) and has the 
ability to add custom parameters. Passes W3C validation. Easy to install and 
use.
</p>
</div>
HTML;
